...
import { editGroup, getGroup, newGroup } from "../groups-number.services"
...
export function Manage() {
  ...
  function handleFormSubmission(e) {
    ...
    if (!isEditMode)
      newGroup(data, () => {
        setTimeout(() => location.assign("/groups-number"), 3000)
      })
  ...
  return (
    <HeadingLine title={isEditMode ? "ویرایش گروه عددی" : "ایجاد گروه عددی"}>
