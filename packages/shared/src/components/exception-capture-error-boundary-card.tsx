...
class ExceptionCaptureErrorBoundaryCard extends Component<
    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="bg-red-100 border border-red-500 p-4 rounded-md">
          ...
          {(this.props.fallback as React.ReactNode) || (
            <p>این خطا برای ما ارسال شده، و روی آن کار خواهیم کرد</p>
          )}
        </div>
      )
    }
...
export default ExceptionCaptureErrorBoundaryCard
